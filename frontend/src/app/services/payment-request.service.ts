...
export class MoneyRequestService {
  ...
  acceptRequest(requestId: number): Observable<any> {
    return this.http.post(`${this.baseUrl}/${requestId}/accept`, {}, { headers: this.getAuthHeaders() });
  }

  declineRequest(requestId: number): Observable<any> {
    return this.http.post(`${this.baseUrl}/${requestId}/decline`, {}, { headers: this.getAuthHeaders() });
  }

  cancelRequest(requestId: number): Observable<any> {
    return this.http.post(`${this.baseUrl}/${requestId}/cancel`, {}, { headers: this.getAuthHeaders() });
  }
  ...
  getSentRequests(): Observable<any[]> {
    return this.http.get<any[]>(`${this.baseUrl}/sent`, { headers: this.getAuthHeaders() });
  }

  getReceivedRequests(): Observable<any[]> {
    return this.http.get<any[]>(`${this.baseUrl}/received`, { headers: this.getAuthHeaders() });
  }

  getRequestById(requestId: number): Observable<any> {
    return this.http.get(`${this.baseUrl}/${requestId}`, { headers: this.getAuthHeaders() });
  }
}